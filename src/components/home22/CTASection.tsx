  ...
  return (
    <Box
      ...
      sx={{
        ...
        overflow: 'hidden',
        background: isDark
          ? 'radial-gradient(ellipse 120% 100% at 50% 0%, rgba(139, 92, 246, 0.04) 0%, #111827 40%, #111827 100%)'
          : 'radial-gradient(ellipse 120% 100% at 50% 0%, rgba(139, 92, 246, 0.02) 0%, #FFFFFF 40%, #FFFFFF 100%)',
      }}
    >
      <Container 
        maxWidth="lg"
